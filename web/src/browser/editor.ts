// Very useful resource: https://microsoft.github.io/monaco-editor/monarch.html
export const LANGUAGE = {
  ...
  keywords: [
      ...
      'BR', 'BRn', 'BRz', 'BRp', 'BRnz', 'BRnp', 'BRzp', 'BRnzp', 'JMP', 'RET', 'JSR', 'JSRR', 'RTI',
  ],
