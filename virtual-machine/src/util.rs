...
mod tests {
    ...
    fn test_binary_add() {
        assert_eq!(
            binary_add(0b0000_0000_0000_0000, 0b0000_0000_0000_0001),
            0b0000_0000_0000_0001
        );
        assert_eq!(
            binary_add(0b0000_0000_0000_0000, 0b1111_1111_1111_1111),
    ...
    fn test_sign_extend_negative() {
        ...
        assert_eq!(
            sign_extend(0b0000_0010_1010_1010, 10),
            0b1111_1110_1010_1010
        );
        assert_eq!(
            sign_extend(0b0000_1000_0000_0001, 12),
            0b1111_1000_0000_0001
        );
    }
    ...
    fn test_sign_extend_positive() {
        ...
        assert_eq!(
            sign_extend(0b0000_1100_1100_1100, 13),
            0b0000_1100_1100_1100
        );
    }
}
